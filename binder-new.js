...
var BINDER = (function () {
    ...
    var Array = ([]).constructor,
                            ...
                            while (next()) {
                                if (c === '}') {
                                    ...
                                    if (c === '{') {
                                        n = parseInt(n, 10) + 1;
                                        if (n < argCount) {
                                            str = str.substring(0, i) + args[n] + str.substring(k);
                                        }
                                    }
                                }
                            }
        ...
        makeList = (function () {
            var defaultItemOperators = {
                ...
                makeList = function (o) {
                    var list = isNaN(o) ? [] : new Array(parseInt(o, 10));
                    ...
                    list.equals = function (otherList, equals) {
                        ...
                        eauals = typeof equals === 'function' ? equals : function () {
            ...
            makeProperty = function (options) {
                ...
                property = {
                    ...
                    get: function () {
                        ...
                        var result = memo === undefined ? this.getter.call(this.owner) : memo;
                        memo = result;
                    ...
                    set: function (value) {
                        ...
                        if (typeof this.setter === 'function') {
                            ...
                            if (!this.equals(value) || this.changed(value)) {
                                memo = undefined;
                                this.setter.call(this.owner, value);
                                this.notify();
                            }
                ...
                (function () {
                    ...
                    if (typeof options === 'function') {
                        self.getter = options;
                        self.setter = null;
                    // {get[, set, lazy, changed, owner]}
                    } else if (isObject(options) && (typeof options.get === 'function' || typeof options.set === 'function')) {
                        lazy = options.lazy;
                        self.getter = options.get;
                        self.setter = typeof options.set === 'function' ? options.set : null;
        ...
        // Creates a functional property as opposed to an object.
        makeFunctionalProperty = (function () {
            var makeFunctionalProperty = function (options) {
                ...
                util.object.mixin(fn, makeProperty(options), makeObservable());

                return fn;
            };

            makeFunctionalProperty.interfce = makeProperty.interfce;

            return makeFunctionalProperty;
        }()),

        // Type can be: 'once', 'oneway' or 'twoway'.
        makeBinding = (function () {
            var makeBinding = function (source, sink, type) {
                var propertyInterface = makeProperty(),
                    subscriptions = [],
                    subscription;

                type = type || 'twoway';
                type = utile.string.toString(type);
    ...
    return {
        ...
        makeProperty: makeFunctionalProperty,
        ...
        toObject: function (o, excludeDependentProperties) {
            ...
            for (key in o) {
                ...
                if (adheresTo(value, propertyInterface)) {
                    if (!excludeDependentProperties || !value.isDependent()) {
