...
this.peek().dependencies().add(b)};g=function(b,a,f){function g(){i=t;h.notify()}var d=z,u=x(),o=[],k,n,i,h;u.add=function(a){this.contains(a)||(this.push(a),o.push(a.subscribe(g)))};h=function(a){var b,c=h.owner;this!==t&&(h.owner=this);arguments.length?(h.set(a),b=this):b=h.get();h.owner=c;return b};h.equals=function(a){var b=this.get(),a=e(a),b=b?b.valueOf():b,a=a?a.valueOf():a;return b===a};h.changed=function(a){var b=this.get(),a=e(a),b=b?b.valueOf():b,a=a?a.valueOf():a;return b!==a};h.clearMemo=
function(){i=t};h.get=function(){d||(c.a(this),c.b(this));var a=i===t?n.call(this.owner):i;i=a;c[c.length-1]===this&&c.pop();return a};h.set=function(a){if("function"===typeof k){d=v;if(!this.equals(a)||this.changed(a))this.block(),k.call(this.owner,a),i=t,this.unblock(),this.notify();d=z}};h.dependencies=function(){return u};h.isDependent=function(){return 0!==u.length};h.toString=function(){return l.str(this.get())};h.valueOf=function(){var a=this.get();return l.isNil(a)?a:a.valueOf()};l.mixin(h,
A());(function(){var c,d=h,i=z,q=l.isObject,w=l.isArray,y=l.adheresTo;d.owner=t;"function"===typeof b?(n=b,k="function"===typeof a?a:null,d.owner="function"===typeof a?f:a):q(b)&&"function"===typeof b.get?(i=b.lazy,n=b.get,k="function"===typeof b.set?b.set:null,d.equals="function"===typeof b.equals?b.equals:d.equals,d.changed="function"===typeof b.changed?b.changed:d.changed,d.owner=b.owner):(q(b)?(d.equals="function"===typeof b.equals?b.equals:d.equals,d.changed="function"===typeof b.changed?b.changed:
d.changed,c=b.value):c=b,w(c)&&!y(c,A.interfce)&&(c=C(c),c.getItemOperators=function(a,b,c){a=typeof a==="function"?a:c.equals;b=typeof b==="function"?b:c.changed;return function(){return{equals:a,changed:b}}}(b.equals,b.changed,c.getItemOperators()),d.equals=function(a){a=e(a);return c.equals(a)},d.changed=function(a){a=e(a);return c.changed(a)}),c&&"function"===typeof c.subscribe&&"function"===typeof c.dispose&&o.push(c.subscribe(g)),n=function(){return c},k=function(a){if(y(c,x.interfce)){c.clear();
w(a)?c.push.apply(c,a):c.push(a)}else if(w(c)){for(;c.length;)c.pop();w(a)?c.push.apply(c,a):c.push(a)}else c!==a&&(c=a)});d.dispose=function(a){return function(){for(;o.length;)o.pop().dispose();for(;u.length;)u.pop();a.call(this)}}(d.dispose);i||h.get()})();return h};e=function(b){return b&&"function"===typeof b.get?b.get():b};g.get=e;g.interfce=l.mixin({dependencies:"function",isDependent:"function",clearMemo:"function",get:"function",set:"function",equals:"function",changed:"function"},A.interfce);
return g}();return{utiljs:l,makeList:x,makeObservable:A,makeObservableList:C,makeProperty:y,makeBinding:function(){function g(e,c,b){var a=y.interfce,f=[],b=b||"twoway",b=l.str(b),b=b.toLowerCase();l.adheresTo(e,a)||r(Error("Binding source must be an observable property. "+e));l.adheresTo(c,a)||r(Error("Binding sink must be an observable property. "+c));c.set(e.get());switch(b){case "oneway":a=e.subscribe(function(){c.set(e.get())});f.push(a);break;case "twoway":a=e.subscribe(function(){c.set(e.get())}),
f.push(a),a=c.subscribe(function(){e.set(c.get())}),f.push(a)}a=null;return{type:function(){return b},source:function(){return e},sink:function(){return c},dispose:function(){for(;f.length;)f.pop().dispose()}}}g.interfce={type:"function",source:"function",sink:"function",dispose:"function"};return g}(),toJSON:w,fromJSON:o}}xport.module(["utiljs"],w,function(){xport("BINDER",w(UTIL))})})();
