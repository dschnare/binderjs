(function(d){function k(){return{p1:d.makeProperty("Mario"),p2:d.makeProperty("Luigi")}}function m(a){strictEqual(a.toString(),"1,2,3",'Expect "p.toString()" to be equal to "1,2,3"');strictEqual(a().join(","),"1,2,3",'Expect "p().join(",")" to be equal to "1,2,3"');strictEqual(a.get().join(","),"1,2,3",'Expect "p.get().join(",")" to be equal to "1,2,3"');strictEqual(a.valueOf().join(","),"1,2,3",'Expect "p.valueOf().join(",")" to be equal to "1,2,3"');a().push(4);strictEqual(a.valueOf().join(","),
...
"function","Expect model.skills to be a function");ok(d.utiljs.isArray(a.skills()),"Expect model.skills() to be an Array");strictEqual(a.skills().join(","),"javascript,html,css,ruby","Expect model.skills() to equal [javascript, html, css, ruby]");strictEqual(typeof a.team,"function","Expect model.team to be a function");ok(d.utiljs.isArray(a.team()),"Expect model.team() to be an Array");strictEqual(a.team()[0].firstName(),"Alex",'Expect model.team()[0].firstName() to equal "Alex"');strictEqual(a.team()[0].lastName(),
...
ok(d.utiljs.isArray(a.skills()),"Expect model.skills() to be an Array");strictEqual(a.skills().join(","),"Javascript,Html,Css,Ruby","Expect model.skills() to equal [Javascript, Html, Css, Ruby]");strictEqual(typeof a.team,"function","Expect model.team to be a function");ok(d.utiljs.isArray(a.team()),"Expect model.team() to be an Array");strictEqual(a.team()[0].name(),"Alex Grendo",'Expect model.team()[0].name() to equal "Alex Grendo"');strictEqual(a.team()[0].firstName,void 0,"Expect model.team()[0].firstName to equal undefined");
...
lastName:d.makeProperty("Wazzabi")}]};b.fullName=d.makeProperty(function(){return b.firstName+" "+b.lastName});a=d.toJSON(b);strictEqual(a.firstName,"Darren",'Expect o.firstName to equal "Darren"');strictEqual(a.lastName,"Schnare",'Expect o.lastName to equal "Schnare"');strictEqual(a.fullName,"Darren Schnare",'Expect o.fullName to equal "Darren Schnare"');ok(d.utiljs.isArray(a.skills),"Expect o.skills to be an Array");strictEqual(a.skills.join(","),"javascript,html,css,ruby","Expect o.skills to equal [javascript, html, css, ruby]");
ok(d.utiljs.isArray(a.team),"Expect o.team to be an Array");strictEqual(a.team[0].firstName,"Alex",'Expect o.team[0].firstName to equal "Alex"');strictEqual(a.team[0].lastName,"Grendo",'Expect o.team[0].lastName to equal "Grendo"');strictEqual(a.team[1].firstName,"Sam",'Expect o.team[1].firstName to equal "Sam"');strictEqual(a.team[1].lastName,"Hilto",'Expect o.team[1].lastName to equal "Hilto"');strictEqual(a.team[2].firstName,"James",'Expect o.team[2].firstName to equal "James"');strictEqual(a.team[2].lastName,
...
" "+b.lastName});a=d.toJSON(b,{exclude:["fullName"],properties:{skills:function(a){return a.charAt(0).toUpperCase()+a.substring(1)},team:{exclude:["firstName","lastName"],filter:function(a,b){a.name=b.firstName+" "+b.lastName;return a}}}});strictEqual(a.firstName,"Darren",'Expect o.firstName to equal "Darren"');strictEqual(a.lastName,"Schnare",'Expect o.lastName to equal "Schnare"');strictEqual(a.fullName,void 0,"Expect o.fullName to equal undefined");ok(d.utiljs.isArray(a.skills),"Expect o.skills to be an Array");
strictEqual(a.skills.join(","),"Javascript,Html,Css,Ruby","Expect o.skills to equal [Javascript, Html, Css, Ruby]");ok(d.utiljs.isArray(a.team),"Expect o.team to be an Array");strictEqual(a.team[0].name,"Alex Grendo",'Expect o.team[0].name to equal "Alex Grendo"');strictEqual(a.team[0].firstName,void 0,"Expect o.team[0].firstName to equal undefined");strictEqual(a.team[0].lastName,void 0,"Expect o.team[0].lastName to equal undefined");strictEqual(a.team[1].name,"Sam Hilto",'Expect o.team[1].name to equal "Sam Hilto"');
...
d.makeProperty("value");ok(d.utiljs.adheresTo(a,d.makeProperty.interfce),'Expect "p" to adhere to the "binder.makeProperty.interfce" interface');notStrictEqual(a.isDependent(),!0,'Expect "p" to not be dependent');strictEqual(a.dependencies().length,0,'Expect "p" to have no dependencies');strictEqual(a.toString(),"value",'Expect "p.toString()" to be equal to "value"');strictEqual(a.valueOf(),"value",'Expect "p.valueOf()" to be equal to "value"');strictEqual(a.get(),"value",'Expect "p.get()" to be equal to "value"');
...
h(a)});test("mergeWith test",function(){var a=g(),b=a.list,a=a.observer;strictEqual(typeof b.mergeWith,"function","Expect list to have an merveWith() method");var c=[1,2,3,1],c=b.mergeWith(c);strictEqual(a.notifiedCount,1,"Expect observer to be notified once");strictEqual(c,void 0,"Expect the result of merging to be undefined");strictEqual(b.join(", "),"1, 2, 3, 1","Expect the list to be unmodified");c=[2,3];a.reset();b.mergeWith(c);strictEqual(a.notifiedCount,1,"Expect observer to be notified once");
...
{id:3,type:"meat",toString:function(){return this.type}}];a.reset();b.subscribe(a);b.mergeWith(c);strictEqual(a.notifiedCount,1,"Expect observer to be notified once");strictEqual(b.join(", "),"fruit, Vegetable, meat","Expect the list to contains [friuit, Vegetable, meat]");h(b)});test("remove test",function(){var a=g(),b=a.list,a=a.observer;strictEqual(typeof b.remove,"function","Expect list to have an remove() method");b.remove(1);strictEqual(a.notifiedCount,1,"Expect observer to be notified once");
strictEqual(b.join(", "),"2, 3","Expect the list to contain [2, 3]");a.reset();b.remove(2,3);strictEqual(a.notifiedCount,1,"Expect observer to be notified once");strictEqual(b.join(", "),"","Expect the list to be empty");h(b)});test("removeAt test",function(){var a=g(),b=a.list,a=a.observer;strictEqual(typeof b.removeAt,"function","Expect list to have an removeAt() method");strictEqual(b.removeAt(0),1,"Expect the item that was removed to be equal to 1");strictEqual(a.notifiedCount,1,"Expect observer to be notified once");
...
"0, 20, 1, 2, 3, 1, 30, 0","Expect the list to contain [0, 20, 1, 2, 3, 1, 30, 0]");a.reset();b.insert(NaN,0);strictEqual(a.notifiedCount,0,"Expect observer to not be notified");e(b)})})(BINDER);
