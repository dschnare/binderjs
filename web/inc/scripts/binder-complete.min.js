...
g.equals:e.equals,e.changed="function"===typeof g.changed?g.changed:e.changed,c=g.value):c=g,w(c)&&!y(c,B.interfce)&&(c=E(c),c.getItemOperators=function(a,b,c){a=typeof a==="function"?a:c.equals;b=typeof b==="function"?b:c.changed;return function(){return{equals:a,changed:b}}}(g.equals,g.changed,c.getItemOperators()),e.equals=function(a){a=k(a);return c.equals(a)},e.changed=function(a){a=k(a);return c.changed(a)}),c&&"function"===typeof c.subscribe&&"function"===typeof c.dispose&&i.push(c.subscribe(d)),
p=function(){return c},o=function(a){if(y(c,u.interfce)){c.clear();w(a)?c.push.apply(c,a):c.push(a)}else if(w(c)){for(;c.length;)c.pop();w(a)?c.push.apply(c,a):c.push(a)}else c!==a&&(c=a)});e.dispose=function(b){return function(){for(;i.length;)i.pop().dispose();for(;a.length;)a.pop();b.call(this)}}(e.dispose);h||j.get()})();return j};k=function(g){return g&&"function"===typeof g.get?g.get():g};i.get=k;i.interfce=n.mixin({dependencies:"function",isDependent:"function",clearMemo:"function",get:"function",
set:"function",equals:"function",changed:"function"},B.interfce);return i}();return{makeList:u,makeObservable:B,makeObservableList:E,makeProperty:y,makeBinding:function(){function i(i,h,g){var f=y.interfce,b=[],g=g||"twoway",g=n.str(g),g=g.toLowerCase();n.adheresTo(i,f)||m(Error("Binding source must be an observable property. "+i));n.adheresTo(h,f)||m(Error("Binding sink must be an observable property. "+h));h.set(i.get());switch(g){case "oneway":f=i.subscribe(function(){h.set(i.get())});b.push(f);
break;case "twoway":f=i.subscribe(function(){h.set(i.get())}),b.push(f),f=h.subscribe(function(){i.set(h.get())}),b.push(f)}f=x;return{type:function(){return g},source:function(){return i},sink:function(){return h},dispose:function(){for(;b.length;)b.pop().dispose()}}}i.interfce={type:"function",source:"function",sink:"function",dispose:"function"};return i}(),toJSON:w,fromJSON:o}}xport.module(["utiljs"],w,function(){xport("BINDER",w(UTIL))})})();
