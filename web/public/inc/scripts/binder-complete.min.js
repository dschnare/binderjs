...
a):c.push(a)}else if(w(c)){for(;c.length;)c.pop();w(a)?c.push.apply(c,a):c.push(a)}else c!==a&&(c=a)});d.dispose=function(a){return function(){for(;o.length;)o.pop().dispose();for(;u.length;)u.pop();a.call(this)}}(d.dispose);i||h.get()})();return h};e=function(b){return b&&"function"===typeof b.get?b.get():b};g.get=e;g.interfce=l.mixin({dependencies:"function",isDependent:"function",clearMemo:"function",get:"function",set:"function",equals:"function",changed:"function"},A.interfce);return g}();return{utiljs:l,
makeList:x,makeObservable:A,makeObservableList:C,makeProperty:y,makeBinding:function(){function g(e,c,b){var a=y.interfce,f=[],b=b||"twoway",b=l.str(b),b=b.toLowerCase();l.adheresTo(e,a)||r(Error("Binding source must be an observable property. "+e));l.adheresTo(c,a)||r(Error("Binding sink must be an observable property. "+c));c.set(e.get());switch(b){case "oneway":a=e.subscribe(function(){c.set(e.get())});f.push(a);break;case "twoway":a=e.subscribe(function(){c.set(e.get())}),f.push(a),a=c.subscribe(function(){e.set(c.get())}),
f.push(a)}a=null;return{type:function(){return b},source:function(){return e},sink:function(){return c},dispose:function(){for(;f.length;)f.pop().dispose()}}}g.interfce={type:"function",source:"function",sink:"function",dispose:"function"};return g}(),toJSON:w,fromJSON:o}}xport.module(["util"],w,function(){xport("BINDER",w(UTIL))})})();
